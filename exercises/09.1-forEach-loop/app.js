...
myArray.forEach((item, index, arr) => {
    ...
    let isDivisible = item % 14 === 0;
    if (isDivisible) {
        console.log(item);
    }
});

//determine in code if a number in the array (item) is diisible by 14 to show or not
//if number is divisible by 14, print,
//if number is not divisible by 14, do not print